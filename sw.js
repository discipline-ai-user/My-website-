const CACHE='discipline-cache-v12';
const ASSETS=['/','/index.html','/app.js','/style.css','/ai-chat.js','/enhancements.js','/pyq-chapters.js','/pyq-persistence.js','/home-intro.js','/manifest.json'];
