const CACHE='discipline-cache-v18';
const ASSETS=['/','/index.html','/boot-debug.js','/app.js','/style.css','/ai-chat.js','/ai-section.js','/syllabus-pyq.js','/enhancements.js','/pyq-persistence.js','/pyq-routing.js','/home-intro.js','/manifest.json'];
